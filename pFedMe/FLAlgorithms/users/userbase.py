...
class User:
    ...
    # The personalized model is tested on the test set of each and every user's test set.
    def test_persionalized_model(self):
        ...
        # Return the number of correctly classified samples as well as the total number of samples present in the test set.
        return test_acc, y.shape[0]
